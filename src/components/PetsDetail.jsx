...
//     const respuesta = window.confirm("Deseas eliminar esta mascota?");

//     if (respuesta) {
//       eliminarMascota(mascota.id_mascota, setMascotas);
//       // setMascota(mascota);
//     }
//   };
...
//   );
// };
// PetsDetail.propTypes = {
//   mascota: PropTypes.object.isRequired,
//   //setMascota: PropTypes.func.isRequired,
//   setMascotas: PropTypes.func.isRequired,
